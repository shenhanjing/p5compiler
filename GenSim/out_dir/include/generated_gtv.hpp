...
class GtvContext {
  public:
    ...
    GtvPackedBuffer pack_gtv_to_bytes() const {
        ...
        append_bits(bits, VLAN_TAG0.VlanInfo._anon_1);
        ...
        append_bits(bits, TCP.DataCtrl._anon_6);
    ...
    void unpack_gtv_from_bytes(const GtvPackedBuffer &in) {
        ...
        assign_from_bits(in, cursor, VLAN_TAG0.VlanInfo._anon_1);
        ...
        assign_from_bits(in, cursor, IPv6._anon_3);
        ...
        assign_from_bits(in, cursor, TCP.DataCtrl._anon_6);
