...
ParserOptions::ParserOptions(std::string_view defaultMessage) : Util::Options(defaultMessage) {
    ...
    registerOption(
        ...
        [this](const char *arg) {
            ...
            } else if (!strcmp(arg, "p5")) {
                langVersion = ParserOptions::FrontendVersion::P5;
            } else {
...
bool ParserOptions::isp4_16() const { return langVersion == ParserOptions::FrontendVersion::P4_16; }

bool ParserOptions::isv1() const { return langVersion == ParserOptions::FrontendVersion::P4_14; }

bool ParserOptions::isp5() const { return langVersion == ParserOptions::FrontendVersion::P5; }
