...
enum class NodeKind : RTTI::TypeId {
  ...
  IDPDKNode = 256,
  DpdkDeclaration = 257,
  DpdkExternDeclaration = 258,
  DpdkHeaderType = 259,
  DpdkHeaderInstance = 260,
  DpdkStructType = 261,
  DpdkAsmStatement = 262,
  DpdkAction = 263,
  DpdkTable = 264,
  DpdkSelector = 265,
  DpdkLearner = 266,
  DpdkAsmProgram = 267,
  DpdkListStatement = 268,
  DpdkApplyStatement = 269,
  DpdkLearnStatement = 270,
  DpdkMirrorStatement = 271,
  DpdkEmitStatement = 272,
  DpdkExtractStatement = 273,
  DpdkLookaheadStatement = 274,
  DpdkJmpStatement = 275,
  DpdkJmpLabelStatement = 276,
  DpdkJmpHitStatement = 277,
  DpdkJmpMissStatement = 278,
  DpdkJmpActionStatement = 279,
  DpdkJmpIfActionRunStatement = 280,
  DpdkJmpIfActionNotRunStatement = 281,
  DpdkJmpHeaderStatement = 282,
  DpdkJmpIfInvalidStatement = 283,
  DpdkJmpIfValidStatement = 284,
  DpdkJmpCondStatement = 285,
  DpdkJmpEqualStatement = 286,
  DpdkJmpNotEqualStatement = 287,
  DpdkJmpGreaterEqualStatement = 288,
  DpdkJmpGreaterStatement = 289,
  DpdkJmpLessOrEqualStatement = 290,
  DpdkJmpLessStatement = 291,
  DpdkRxStatement = 292,
  DpdkTxStatement = 293,
  DpdkAssignmentStatement = 294,
  DpdkUnaryStatement = 295,
  DpdkMovStatement = 296,
  DpdkMovhStatement = 297,
  DpdkBinaryStatement = 298,
  DpdkAddStatement = 299,
  DpdkAndStatement = 300,
  DpdkShlStatement = 301,
  DpdkShrStatement = 302,
  DpdkSubStatement = 303,
  DpdkOrStatement = 304,
  DpdkXorStatement = 305,
  DpdkRecircidStatement = 306,
  DpdkReturnStatement = 307,
  DpdkRearmStatement = 308,
  DpdkRecirculateStatement = 309,
  DpdkLabelStatement = 310,
  DpdkChecksumAddStatement = 311,
  DpdkChecksumSubStatement = 312,
  DpdkChecksumClearStatement = 313,
  DpdkHashDeclStatement = 314,
  DpdkGetHashStatement = 315,
  DpdkGetChecksumStatement = 316,
  DpdkCastStatement = 317,
  DpdkVerifyStatement = 318,
  DpdkMeterDeclStatement = 319,
  DpdkMeterExecuteStatement = 320,
  DpdkGetTableEntryIndex = 321,
  DpdkCounterCountStatement = 322,
  DpdkRegisterDeclStatement = 323,
  DpdkRegisterReadStatement = 324,
  DpdkRegisterWriteStatement = 325,
  DpdkValidateStatement = 326,
  DpdkInvalidateStatement = 327,
  DpdkDropStatement = 328,
  TCKernelMetadata = 329,
  TCActionParam = 330,
  TCDefaultActionParam = 331,
  TCAction = 332,
  TCEntry = 333,
  TCTable = 334,
  TCKey = 335,
  TCExternInstance = 336,
  TCExtern = 337,
  TCPipeline = 338,
  IDeclaration = 339,
  VectorBase = 340
